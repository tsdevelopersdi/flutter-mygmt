...
class ADTWorkingDocFormPage extends StatelessWidget {
  final List<InspectionRow>? initialRows;
  final void Function(List<InspectionRow> rows)? onSave;

  const ADTWorkingDocFormPage({super.key, this.initialRows, this.onSave});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Articulated Dump Truck Inspection Form'),
...
class _WorkingDocFormState extends State<WorkingDocForm> {
  ...
  List<InspectionRow> _defaultRows() => [
    ...
    InspectionRow(
      number: 17,
      inspectionRef: 'Aritculated Pin/Bushing',
      thing: 'Periksa pin/bushing dan grease',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 20,
      inspectionRef: 'Pin & Bushing Link Dumping',
      thing: 'Periksa pin/bushing dan grease',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 21,
      inspectionRef: 'Spring RH',
      thing: 'Periksa plat, pin & bolt/nut',
      condition: 'good',
      notes: "",
      action: 'none',
      actionDate: null,
    ...
    InspectionRow(
      number: 36,
      inspectionRef: 'Clutch',
      thing: 'Periksa sistem operasi',
      condition: 'good',
      notes: "",
      action: 'none',
      actionDate: null,
    ...
    InspectionRow(
      number: 70,
      inspectionRef: 'Tire',
      thing: 'Periksa tekanan dan kondisi ban',
      condition: 'good',
      notes: "",
      actionDate: null,
    ),
  ...
  void _save() {
    ...
    // Validation: top-form fields required: 'Tanggal', 'Jam Inspeksi', 'Foto', 'Site Project', 'Lokasi Inspeksi'
