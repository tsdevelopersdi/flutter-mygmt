...
class DozerFormPage extends StatelessWidget {
  final List<InspectionRow>? initialRows;
  final void Function(List<InspectionRow> rows)? onSave;

  const DozerFormPage({super.key, this.initialRows, this.onSave});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Bulldozer Inspection FormA'),
...
class _WorkingDocFormState extends State<WorkingDocForm> {
  ...
  List<InspectionRow> _defaultRows() => [
    ...
    InspectionRow(
      number: 2,
      inspectionRef: 'Blade',
      thing: 'Periksa keausan shank dan bolt/nut',
      condition: 'good',
      notes: "",
      action: 'none',
      actionDate: null,
    ...
    InspectionRow(
      number: 4,
      inspectionRef: 'Pin/Bushing Lift Cyl - RH',
    ...
    InspectionRow(
      number: 5,
      inspectionRef: 'Pin/Bushing Lift Cyl - LH',
      thing: 'Periksa pin/bushing dan grease',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 6,
      inspectionRef: 'Pin/Bushing Ripper Cyl - RH',
      thing: 'Periksa pin/bushing dan grease',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 7,
      inspectionRef: 'Pin/Bushing Ripper Cyl - LH',
      thing: 'Periksa pin/bushing dan grease',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 9,
      inspectionRef: 'Ripper Teeth',
      thing: 'Periksa keausan ripper dan lock',
      condition: 'good',
      notes: "",
      action: 'none',
      actionDate: null,
    ...
    InspectionRow(
      number: 15,
      inspectionRef: 'Blade Lift Cyl - RH',
      thing: 'Periksa kebocoran, barrel dan rod',
      condition: 'good',
      notes: "",
      action: 'none',
      actionDate: null,
    ...
    InspectionRow(
      number: 16,
      inspectionRef: 'Blade Lift Cyl - LH',
      thing: 'Periksa kebocoran, barrel dan rod',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 17,
      inspectionRef: 'Ripper Lift Cyl - Top RH',
      thing: 'Periksa kebocoran, barrel dan rod',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 18,
      inspectionRef: 'Ripper Lift Cyl - Bottom RH',
      thing: 'Periksa kebocoran, barrel dan rod',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 19,
      inspectionRef: 'Ripper Lift Cyl - Top LH',
      thing: 'Periksa kebocoran, barrel dan rod',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 20,
      inspectionRef: 'Ripper Lift Cyl - Bottom LH',
      thing: 'Periksa kebocoran, barrel dan rod',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 21,
      inspectionRef: 'Pin/Bushing Trunion',
      thing: 'Periksa pin/bushing dan grease',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 22,
      inspectionRef: 'Greasing Pin Trunion',
      thing: 'Periksa pin/bushing dan grease',
      condition: 'good',
      notes: "",
      action: 'none',
  ...
  void _save() {
    ...
    for (final r in rows) {
      if ((r.action == 'repair' || r.action == 'replace')) {
        if (r.actionDate == null || r.photo == null) {
          errors.add('Row ${r.number}: Date and Photo are required for action "${r.action}".');
        }
      }
    }
    ...
    final box = Hive.box('dozer_forms');
    final formId = const Uuid().v4();
    final topForm = {
      'is_uploaded': 'no',
      'form_type': 'dozer_form',
      'form_id': formId,
  ...
  Widget build(BuildContext context) {
    ...
    List<DataRow> _buildTableRows() {
      ...
      for (final r in rows.where((r) => r.number >= 15 && r.number <= 20)) {
        tableRows.add(_buildRow(r));
      }

      // Group 6
      addDivider("▶ Frame / Chasis");
      for (final r in rows.where((r) => r.number >= 21 && r.number <= 24)) {
        tableRows.add(_buildRow(r));
      }

      // Group 6
      addDivider("▶ Engine");
      for (final r in rows.where((r) => r.number >= 25 && r.number <= 36)) {
        tableRows.add(_buildRow(r));
      }

      // Group 7
      addDivider("▶ Transmission and Final Drive");
      for (final r in rows.where((r) => r.number >= 37 && r.number <= 40)) {
        tableRows.add(_buildRow(r));
      }

      // Group 8
      addDivider("▶ Cabin");
      for (final r in rows.where((r) => r.number >= 41 && r.number <= 49)) {
        tableRows.add(_buildRow(r));
      }
