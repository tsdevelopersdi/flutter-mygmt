...
class WLFormEditPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Wheel Loader Inspection Edit Page'),
          ...
          children: [
            Row(
              children: [
                ...
                // Use the same unit list as in wl_form_page.dart
                _labeledField(
                  "Pilih Unit",
                  DropdownButtonFormField<String>(
                    ...
                    onPressed: () async {
                      ...
                      try {
                        ...
                        final exportFileName =
                            '${username}_wl_form_${inspectionDate}_${inspectionTime}.xlsx';
                        ...
                        if (topForm['foto_extra'] != null &&
                          ...
                          if (await extraPhotoFile.exists()) {
                            final ext =
                                ...
                                : '';
                            extraPhotoFilename =
                                'wl_form_${inspectionDate}_${inspectionTime}_topform$ext';
                          ...
                          if (row.photo?.path != null && row.photo!.path.isNotEmpty) {
                            ...
                            if (await photoFile.exists()) {
                              final ext =
                                  ...
                                  : '';
                              photoFilename =
                                  'wl_form_${inspectionDate}_${inspectionTime}_row${row.number}$ext';
                        ...
                        if (excelData != null) {
                          ...
                          final zipFile = File(
                            '$dirPath/${username}_wl_form_${inspectionDate}_${inspectionTime}.zip',
                          );
                          ...
                          if (response.statusCode == 200) {
                            ...
                            try {
                              ...
                              final hiveKey = context
                                  .findAncestorWidgetOfExactType<WLFormEditPage>()
                                  ?.hiveKey;
