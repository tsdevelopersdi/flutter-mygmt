...
class GraderFormPage extends StatelessWidget {
  final List<InspectionRow>? initialRows;
  final void Function(List<InspectionRow> rows)? onSave;

  const GraderFormPage({super.key, this.initialRows, this.onSave});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Grader Inspection Form'),
...
class _WorkingDocFormState extends State<WorkingDocForm> {
  ...
  List<InspectionRow> _defaultRows() => [
    InspectionRow(
      number: 1,
      inspectionRef: 'Tire',
      thing: 'Lakukan pemeriksaan saat Inspeksi Tire',
      condition: 'good',
      notes: "",
      action: 'none',
      actionDate: null,
    ...
    InspectionRow(
      number: 16,
      inspectionRef: 'Hose Blade Lift Cyl - RH',
      thing: 'Periksa kebocoran dan kekakuan',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 18,
      inspectionRef: 'Hose Blade Lift Cyl - LH',
      thing: 'Periksa kebocoran dan kekakuan',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 20,
      inspectionRef: 'Hose Blade Swing Cyl',
      thing: 'Periksa kebocoran dan kekakuan',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 22,
      inspectionRef: 'Hose Ripper Lift Cyl',
      thing: 'Periksa kebocoran dan kekakuan',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 23,
      inspectionRef: 'Pin/Bushing Articulate',
      thing: 'Periksa pin/bushing dan grease',
      condition: 'good',
      notes: "",
      action: 'none',
    ...
    InspectionRow(
      number: 24,
      inspectionRef: 'Blade Swing Frame',
      thing: 'Periksa retak',
      condition: 'good',
      notes: "",
      action: 'none',
