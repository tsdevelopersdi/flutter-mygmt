...
// import 'package:inspection_app_gmt_3/forms/grader_form_edit_page.dart';
// import 'package:inspection_app_gmt_3/forms/grader_form_page.dart';

// class GraderListPage extends StatelessWidget {
//   const GraderListPage({Key? key}) : super(key: key);

//   Future<Box> _openFormsBox() async {
//     if (!Hive.isBoxOpen('grader_forms')) {
//       if (!Hive.isAdapterRegistered(0)) {
//         // quick check for initialization
//         await Hive.initFlutter();
//       }
//       return await Hive.openBox('grader_forms');
//     }
//     return Hive.box('grader_forms');
//   }
...
//         return Scaffold(
//           appBar: AppBar(title: const Text("Grader Forms")),
//           body: ValueListenableBuilder(
//             valueListenable: formsBox.listenable(),
//             builder: (context, Box box, _) {
//               final allForms = box.values.toList();
//               final graderForms = allForms.where((form) {
//                 final f = form as Map;
//                 return f["form"]?["form_type"] == "grader_form";
//               }).toList();

//               if (graderForms.isEmpty) {
//                 return const Center(child: Text("No Grader forms found."));
//               }

//               return ListView.builder(
//                 itemCount: graderForms.length,
//                 itemBuilder: (context, index) {
//                   final form = graderForms[index] as Map;
...
//                             context,
//                             MaterialPageRoute(
//                               builder: (context) => GraderFormEditPage(
...
//             heroTag: 'grader_list_fab_main',
//             onPressed: () {
//               Navigator.of(context).push(
//                 MaterialPageRoute(builder: (context) => const GraderFormPage()),
//               );
//             },
...
class GraderListPage extends StatefulWidget {
  const GraderListPage({Key? key}) : super(key: key);

  @override
  State<GraderListPage> createState() => _GraderListPageState();
}

class _GraderListPageState extends State<GraderListPage> {
  String _searchQuery = "";
  ...
  Widget _buildBodyContent(Box formsBox) {
    return ValueListenableBuilder(
      ...
      builder: (context, Box box, _) {
        ...
        final GraderFormsWithKeys = [];
        for (int i = 0; i < allForms.length; i++) {
          final form = allForms[i] as Map;
          if (form["form"]?["form_type"] == "grader_form") {
            GraderFormsWithKeys.add({'key': allKeys[i], 'form': form});
          }
        }

        final filteredForms = GraderFormsWithKeys.where((item) {
        ...
        if (filteredForms.isEmpty) {
          return const Center(child: Text("No matching Grader forms found."));
        }
