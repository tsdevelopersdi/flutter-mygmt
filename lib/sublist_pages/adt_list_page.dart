...
// import '../forms/adt_form_page.dart';
// import 'package:flutter/material.dart';
// import 'package:hive_flutter/hive_flutter.dart';

// class ADTListPage extends StatelessWidget {
//   const ADTListPage({Key? key}) : super(key: key);
...
//       }
//       return await Hive.openBox('forms');
//     }
//     return Hive.box('forms');
//   }
...
//         return Scaffold(
//           appBar: AppBar(title: const Text("ADT Forms")),
//           body: ValueListenableBuilder(
//             valueListenable: formsBox.listenable(),
//             builder: (context, Box box, _) {
//               final allForms = box.values.toList();
//               final adtForms = allForms.where((form) {
//                 final f = form as Map;
//                 return f["form"]?["form_type"] == "adt_form";
//               }).toList();

//               if (adtForms.isEmpty) {
//                 return const Center(child: Text("No ADT forms found."));
//               }

//               return ListView.builder(
//                 itemCount: adtForms.length,
//                 itemBuilder: (context, index) {
//                   final form = adtForms[index] as Map;
...
//                             context,
//                             MaterialPageRoute(
//                               builder: (context) => ADTeditWorkingDocFormPage(
...
//             heroTag: 'adt_list_fab_main',
//             onPressed: () {
//               Navigator.of(context).push(
//                 MaterialPageRoute(
//                   builder: (context) => const ADTWorkingDocFormPage(),
//                 ),
//               );
//             },
...
class ADTListPage extends StatefulWidget {
  const ADTListPage({Key? key}) : super(key: key);

  @override
  State<ADTListPage> createState() => _ADTListPageState();
}

class _ADTListPageState extends State<ADTListPage> {
  String _searchQuery = "";
  ...
  Widget _buildBodyContent(Box formsBox) {
    return ValueListenableBuilder(
      ...
      builder: (context, Box box, _) {
        ...
        final adtFormsWithKeys = [];
        for (int i = 0; i < allForms.length; i++) {
          final form = allForms[i] as Map;
          if (form["form"]?["form_type"] == "adt_form") {
            adtFormsWithKeys.add({'key': allKeys[i], 'form': form});
          }
        }

        final filteredForms = adtFormsWithKeys.where((item) {
        ...
        if (filteredForms.isEmpty) {
          return const Center(child: Text("No matching ADT forms found."));
        }
