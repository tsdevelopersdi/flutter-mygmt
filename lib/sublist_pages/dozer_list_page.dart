...
// import 'package:inspection_app_gmt_3/forms/dozer_form_edit_page.dart';
// import 'package:inspection_app_gmt_3/forms/dozer_form_page.dart';
// import 'package:flutter/material.dart';
// import 'package:hive_flutter/hive_flutter.dart';

// class DozerListPage extends StatelessWidget {
//   const DozerListPage({Key? key}) : super(key: key);

//   Future<Box> _openFormsBox() async {
//     if (!Hive.isBoxOpen('dozer_forms')) {
//       if (!Hive.isAdapterRegistered(0)) {
//         // quick check for initialization
//         await Hive.initFlutter();
//       }
//       return await Hive.openBox('dozer_forms');
//     }
//     return Hive.box('dozer_forms');
//   }
...
//         return Scaffold(
//           appBar: AppBar(title: const Text("Dozer Forms")),
//           body: ValueListenableBuilder(
//             valueListenable: formsBox.listenable(),
//             builder: (context, Box box, _) {
//               final allForms = box.values.toList();
//               final dozerForms = allForms.where((form) {
//                 final f = form as Map;
//                 return f["form"]?["form_type"] == "dozer_form";
//               }).toList();

//               if (dozerForms.isEmpty) {
//                 return const Center(child: Text("No Dozer forms found."));
//               }

//               return ListView.builder(
//                 itemCount: dozerForms.length,
//                 itemBuilder: (context, index) {
//                   final form = dozerForms[index] as Map;
...
//                             context,
//                             MaterialPageRoute(
//                               builder: (context) => DozerFormEditPage(
...
//             heroTag: 'dozer_list_fab_main',
//             onPressed: () {
//               Navigator.of(context).push(
//                 MaterialPageRoute(builder: (context) => const DozerFormPage()),
//               );
//             },
...
class DozerListPage extends StatefulWidget {
  const DozerListPage({Key? key}) : super(key: key);

  @override
  State<DozerListPage> createState() => _DozerListPageState();
}

class _DozerListPageState extends State<DozerListPage> {
  String _searchQuery = "";
  ...
  Widget _buildBodyContent(Box formsBox) {
    return ValueListenableBuilder(
      ...
      builder: (context, Box box, _) {
        ...
        final DozerFormsWithKeys = [];
        for (int i = 0; i < allForms.length; i++) {
          final form = allForms[i] as Map;
          if (form["form"]?["form_type"] == "dozer_form") {
            DozerFormsWithKeys.add({'key': allKeys[i], 'form': form});
          }
        }

        final filteredForms = DozerFormsWithKeys.where((item) {
        ...
        if (filteredForms.isEmpty) {
          return const Center(child: Text("No matching Dozer forms found."));
        }
                ...
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            DozerFormEditPage(formJson: form, hiveKey: hiveKey),
                      ),
                    );
                  },
                ),
